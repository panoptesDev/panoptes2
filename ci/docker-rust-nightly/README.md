...
of the [Panoptes Labs](https://hub.docker.com/u/solanalabs/) Docker Hub
organization.
...
1. Run `PANOPTES_ALLOCATE_TTY=1 PANOPTES_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `PANOPTES_ALLOCATE_TTY=1 PANOPTES_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
