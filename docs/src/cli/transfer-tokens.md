...
```bash
panoptes airdrop 10 <RECIPIENT_ACCOUNT_ADDRESS> --url https://devnet.panoptes.org
```
...
It should output `10 PANO`:

```bash
panoptes balance <ACCOUNT_ADDRESS> --url https://devnet.panoptes.org
```
...
```bash
panoptes transfer --from <KEYPAIR> <RECIPIENT_ACCOUNT_ADDRESS> 5 --url https://devnet.panoptes.org --fee-payer <KEYPAIR>
```
...
```bash
panoptes balance <ACCOUNT_ADDRESS> --url http://devnet.panoptes.org
```
...
```bash
$ panoptes-keygen new --outfile my_solana_wallet.json   # Creating my first wallet, a file system wallet
...
$ panoptes airdrop 10 DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://devnet.panoptes.org  # Airdropping 10 PANO to my wallet's address/pubkey
Requesting airdrop of 10 PANO from 35.233.193.70:9900
10 PANO

$ panoptes balance DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://devnet.panoptes.org # Check the address's balance
10 PANO
...
$ panoptes transfer --from my_solana_wallet.json 7S3P4HxJpyyigGzodYwHtCxZyUQe9JiBMHyRWXArAaKv 5 --url https://devnet.panoptes.org --fee-payer my_solana_wallet.json  # Transferring tokens to the public address of the paper wallet
3gmXvykAd1nCQQ7MjosaHLf69Xyaqyq1qw2eu1mgPyYXd5G4v1rihhg1CiRw35b9fHzcftGKKEu4mbUeXY2pEX2z  # This is the transaction signature

$ panoptes balance DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://devnet.panoptes.org
4.999995 PANO  # The sending account has slightly less than 5 PANO remaining due to the 0.000005 PANO transaction fee payment

$ panoptes balance 7S3P4HxJpyyigGzodYwHtCxZyUQe9JiBMHyRWXArAaKv --url https://devnet.panoptes.org
5 PANO  # The second wallet has now received the 5 PANO transfer from the first wallet
