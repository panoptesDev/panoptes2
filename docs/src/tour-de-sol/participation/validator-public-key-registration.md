...
## Link your Panoptes pubkey to a Keybase account

You must link your Panoptes pubkey to a Keybase.io account. The following instructions describe how to do that by installing Keybase on your server.
...
3. Create a Panoptes directory in your public file folder: `mkdir /keybase/public/<KEYBASE_USERNAME>/solana`
