---
title: Panoptes Wallet Guide
---

This document describes the different wallet options that are available to users
of Panoptes who want to be able to send, receive and interact with
PANO tokens on the Panoptes blockchain.
...
Panoptes supports multiple types of wallets so you can choose the right balance
of security and convenience.

**If you want to be able to receive PANO tokens on the Panoptes blockchain,
you first will need to create a wallet.**

## Supported Wallets

Panoptes supports several types of wallets in the Panoptes native
...
may be more appropriate, as new features on the Panoptes blockchain will always be
