...
Panoptes supports several different types of wallets that can be used to interface
directly with the Panoptes command-line tools.
...
To use a Command Line Wallet, you must first [install the Panoptes CLI tools](../cli/install-solana-cli-tools.md)
