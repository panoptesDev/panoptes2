...
funds in that wallet will be lost permanently.  Neither the Panoptes team nor the
...
the Panoptes app](ledger-live.md#upgrade-to-the-latest-version-of-the-solana-app)
on your device.

#### Select a Ledger address to access
Plug in your Nano and open the Panoptes app so the device screen displays
...
Panoptes maintains [three distinct networks](../clusters), each of which has
its own purpose in supporting the Panoptes ecosystem.  Mainnet Beta is selected by
...
about how staking on Panoptes works in general, check out our
