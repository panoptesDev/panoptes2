...
First, setup Rust, Cargo and system packages as described in the Panoptes [README](https://github.com/solana-labs/solana#1-install-rustc-cargo-and-rustfmt)
...
```bash
NDEBUG=1 ./multinode-demo/bench-tps.sh --entrypoint devnet.panoptes.org:10015 --faucet devnet.panoptes.org:9900 --duration 60 --tx_count 50
```

You can observe the effects of your client's transactions on our [metrics dashboard](https://metrics.panoptes.org:3000/d/monitor/cluster-telemetry?var-testnet=devnet)
