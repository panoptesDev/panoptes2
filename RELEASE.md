...
Go to [Panoptes Releases](https://github.com/solana-labs/solana/releases) and click on the latest release that you just published.
...
[Crates.io](https://crates.io/crates/solana) should have an updated Panoptes version.  This can take 2-3 hours, and sometimes fails in the `solana-secondary` job.
If this happens and the error is non-fatal, click "Retry" on the "publish crate" job

### Update software on devnet.panoptes.org/testnet.panoptes.org/mainnet-beta.panoptes.org
