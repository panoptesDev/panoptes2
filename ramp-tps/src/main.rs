//! Ramp up TPS for Tour de PANO until all validators drop out
...
const DEFAULT_INITIAL_PANO_BALANCE: &str = "1";
    ...
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("initial_balance")
                ...
                .value_name("PANO")
                .takes_value(true)
                .default_value(DEFAULT_INITIAL_PANO_BALANCE)
                .help("The number of PANO that each partipant started with"),
        )
        .arg(
